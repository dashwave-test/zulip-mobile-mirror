...
import DocumentationScreen from '../documentation/DocumentationScreen'; // Import the new DocumentationScreen
...
export type AppNavigatorParamList = {|
  ...
  +'documentation': RouteParamsOf<typeof DocumentationScreen>, // Add the documentation route
|};
...
export default function AppNavigator(props: Props): Node {
  ...
  return (
    ...
    >
      ...
      <Stack.Screen name="documentation" component={DocumentationScreen} /> {/* Add the documentation screen */}
    </Stack.Navigator>
  );
}
