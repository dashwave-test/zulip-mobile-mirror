...
import WebViewScreen from '../webview/WebViewScreen'; // Import the WebViewScreen
...
export type AppNavigatorParamList = {|
  ...
  +'web-view': RouteParamsOf<typeof WebViewScreen>, // Add the web-view route
|};
...
export default function AppNavigator(props: Props): Node {
  ...
  return (
    ...
    >
      ...
      <Stack.Screen name="web-view" component={WebViewScreen} /> {/* Add the WebViewScreen */}
    </Stack.Navigator>
  );
}
