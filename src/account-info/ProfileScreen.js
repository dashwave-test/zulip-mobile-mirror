...
import { IconSettings, IconSwitchAccount, IconLogout, IconAccountCircle } from '../common/Icons';
    ...
    <SafeAreaView mode="padding" edges={['top']} style={{ flex: 1 }}>
      ...
      <ScrollView>
        ...
        <NavRow
          ...
          onPress={() => handlePress('user-status')}
        />
        ...
        <NavRow
          ...
          title="Full profile"
          onPress={() => handlePress('account-details', { userId: ownUserId })}
        />
        <NavRow
          leftElement={{
            type: 'icon',
        ...
        <NavRow
          leftElement={{
            type: 'icon',
            Component: IconSwitchAccount,
          }}
          title="Switch account"
          onPress={() => handlePress('account-pick')}
        />
        <NavRow
          leftElement={{
            type: 'icon',
